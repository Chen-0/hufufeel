...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-offset-3 col-lg-6">
            ...
            <form role="form" method="post" action="/waybill/${waybill.id}/send" id="main">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="outWeight">货物出库重（磅）（必填）：</label>
                            <input type="text" class="form-control" id="outWeight" name="outWeight" value="${waybill.weight}">
                        </div>
                    </div>
                    <div class="panel-footer">
                        <button class="btn btn-primary" id="add" type="submit">提交</button>
                    </div>
                </div>
