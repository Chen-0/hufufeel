...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="/">虎芙管家后台管理系统</a>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">
                        海淘客运单管理<span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a href="/waybill/index?s=0">货物入库</a></li>
                        <li><a href="/waybill/index?s=1">未支付运单</a></li>
                        <li><a href="/waybill/index?s=3">发货管理</a></li>
                        <li><a href="/waybill/index?s=4">补差发货管理</a></li>
                        <li><a href="/waybill/index?s=5">已出库运单</a></li>
                        <li><a href="/waybill/index?s=99">合并订单管理</a></li>
                    </ul>
                </li>
            </ul>
