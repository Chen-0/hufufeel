        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="lazy-load" lazy-load-src="/static/assets/images/1.jpg" src="/static/assets/images/none.jpg">
                </div>
                <div class="item">
                    <img class="lazy-load" lazy-load-src="/static/assets/images/2.jpg" src="/static/assets/images/none.jpg">
                </div>
                <div class="item">
                    <img class="lazy-load" lazy-load-src="/static/assets/images/3.jpg" src="/static/assets/images/none.jpg">
                </div>
                <div class="item">
                    <img class="lazy-load" lazy-load-src="/static/assets/images/4.jpg" src="/static/assets/images/none.jpg">
                </div>
            </div>
        ...
        <div class="row">
            <div style="margin: 15px auto; width: 960px">
                ...
                <div style="display: inline-block;vertical-align: top;">
                    <img src="/static/assets/images/bg1.jpg">
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        var $nextImage = $('#carousel').find('img');
        for (var i = 0; i < $nextImage.length; i++) {
            var ele = $($nextImage[i]);
            if (ele.hasClass('lazy-load')) {
                ele.removeClass('lazy-load');
