                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-sm-4 radio">
                                <label>
                                <#assign bar= (cs.thrkt == "TH_RK_AD")>
                                    <input type="radio" name="thrkt" value="TH_RK_AD" ${bar?string("checked", "")}>按箱收费（USD）
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <select class="form-control" id="INP_TH_RK_AD">
                                <#list INP_TH_RK_AD as v>
                                    <#assign foo=false>
                                    <#if bar>
                                        <#assign foo=(cs.thrkv?string == v)>
                                    </#if>
                                    <option value="${v}" ${foo?string("selected", "")}>${v}</option>
                                </#list>
                                </select>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-sm-4 radio">
                                <label>
                                <#assign bar= (cs.thsjt == "TH_SJ_SL")>
                                    <input type="radio" name="thsjt" value="TH_SJ_SL" ${bar?string("checked", "")}>按数量收费（USD）
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <select class="form-control" id="INP_TH_SJ_SL">
                                <#list INP_TH_SJ_SL as v>
                                    <#assign foo=false>
                                    <#if bar>
                                        <#assign foo=(cs.thsjv?string == v)>
                                    </#if>
                                    <option value="${v}" ${foo?string("selected", "")}>${v}</option>
                                </#list>
                                </select>
...
<script>
    $(function () {
        $('#submit').click(function (e) {
            ...
            var thrkt = $('input[name=thrkt]:checked').val();
            var thrkv = $('#INP_' + thrkt).val();

            var thsjt = $('input[name=thsjt]:checked').val();
            var thsjv = $('#INP_' + thsjt).val();
