...
public class AlipayService {
    ...
    private String notify_url = "https://www.hufufeel.com/Pay/notifyurl";
    private String return_url = "https://www.hufufeel.com/Pay/returnurl";
    ...
    public Map<String, String> pay(
        ...
        map.put("notify_url", "https://www.hufufeel.com/pay/alipay/notify");
        map.put("return_url", "https://www.hufufeel.com/pay/alipay/success");
