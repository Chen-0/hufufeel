...
public class AlipaySubmit {
    ...
    public static void main(String[] args) {
        ...
        map.put("notify_url", "https://www.hufufeel.com/Pay/notifyurl");
        map.put("return_url", "https://www.hufufeel.com/Pay/returnurl");
    ...
    public static Map<String, String> submit(Map<String, String> sParaTemp) {
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        return sPara;
    }

    public static String buildRequest(Map<String, String> sParaTemp) {
        return buildRequest(sParaTemp, "get", "Submit");
    }
...
//        sbHtml.append("<script>document.forms['alipaysubmit'].submit();</script>");
        ...
        return MessageFormat.format("<html><head><meta charset=\"utf-8\"></head><body>{0}</body></html>", sbHtml.toString());
    }
